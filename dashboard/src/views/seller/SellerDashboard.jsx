  ...
  return (
    <div className="px-2 md:px-7 py-5">
      <div className="w-full grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-7">
        <div className="flex flex-col justify-between items-center p-5 bg-dashboard-mode rounded-md gap-3">
          <div className="flex flex-col justify-start items-start text-light">
            <h2 className="text-3xl font-bold">$66666</h2>
            <span className="text-md font-medium">مجموع درآمد</span>
          </div>
        ...
        <div className="flex flex-col justify-between items-center p-5 bg-blue-mode rounded-md gap-3">
          <div className="flex flex-col justify-start items-start text-light">
            ...
            <span className="text-md font-medium">سفارشات</span>
          </div>
          <div className="w-[46px] h-[47px] rounded-full bg-[#00cfe81f] flex justify-center items-center text-xl">
            <AiOutlineShoppingCart className="text-[#00ece8] shadow-lg" />
          </div>
        </div>
        <div className="flex flex-col justify-between items-center p-5 bg-blue-mode rounded-md gap-3">
          <div className="flex flex-col justify-start items-start text-light">
            <h2 className="text-3xl font-bold">20</h2>
            <span className="text-md font-medium">سفارشات معلق</span>
          </div>
          <div className="w-[46px] h-[47px] rounded-full bg-[#e000e81f] flex justify-center items-center text-xl">
            <AiOutlineShoppingCart className="text-[#cd0038] shadow-lg" />
          </div>
        </div>
      </div>
      <div className="w-full flex flex-wrap mt-7">
        <div className="w-full lg:w-7/12 lg:pr-3">
          <div className="w-full bg-blue-mode p-4 rounded-md">
            <Chart
        ...
        <div className="w-full lg:w-5/12 lg:pl-4 mt-6 lg:mt-0">
          <div className="w-full bg-dashboard-mode p-4 rounded-md text-[#d0d2d6]">
      ...
      <div className="w-full p-4  bg-dashboard-mode rounded-md mt-6">
        <div className="flex justify-between items-center">
          <h2 className="font-semibold text-lg text-[#d0d2d6] pb-3">
            Recent Orders
          </h2>
