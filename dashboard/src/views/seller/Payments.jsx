  ...
  return (
    <div className="px-2 md:px-7 py-5">
      <div className="w-full grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-3 mb-5">
        <div className="flex justify-between items-center p-5 bg-blue-mode rounded-md gap-3">
        ...
        <div className="flex justify-between items-center p-5 bg-blue-mode rounded-md gap-3">
          ...
          <div className="w-[46px] h-[47px] rounded-full bg-blue-mode flex justify-center items-center text-xl">
            <BsCurrencyDollar className="text-[#7367f0] shadow-lg" />
          </div>
        </div>
      </div>
      <div className="w-full grid grid-cols-1 md:grid-cols-2 gap-3 pb-4">
        <div className="bg-blue-mode  text-[#d0d2d6] rounded-md p-5">
            ...
            <form>
              <div className="flex gap-3 flex-wrap">
                <input
                  ...
                  min="0"
                  type="number"
                  className="px-3 md:w-[79%] py-2 focus:border-indigo-500 outline-none bg-blue-mode border border-slate-700 rounded-md text-[#d0d2d6]"
                  name="amount"
                />
