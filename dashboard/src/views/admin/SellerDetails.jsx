...
<img src="http://localhost:3000/images/logo.png" alt="" />
                ...
                <div className='w-4/12'>
                    <div className='px-0 md:px-5 py-2'>
                        ...
                        <div className='flex justify-between text-sm flex-col gap-2 p-4 bg-dashboard-mode rounded-md'>
                ...
                <div className='w-4/12'>
                    <div className='px-0 md:px-5 py-2'>
                        ...
                        <div className='flex justify-between text-sm flex-col gap-2 p-4 bg-dashboard-mode rounded-md'>
                            ...
                            <div className='flex gap-2'>
                                <span>Division : </span>
                                <span>seler shop infodivision</span>
                            </div>
                            <div className='flex gap-2'>
                                <span>District : </span>
                                <span>seler shop info</span>
                            </div>
                            <div className='flex gap-2'>
                                <span>Sub-District : </span>
                                <span>seler info</span>
                            </div>
                        </div>
                    </div>
                </div>
